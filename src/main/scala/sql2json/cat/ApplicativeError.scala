...
import Bifunctor.syntax

trait ApplicativeError[C[_]] extends Applicative[C]
  type E
...
object ApplicativeError
  ...
  def apply[C[_], E](given AE: Aux[C,E]) = AE
  ...
  given lifts[E]: ApplicativeErrorLifts[E]
  given syntax[C[_],A]: ApplicativeErrorOps[C,A]